      ...
      <Paper className={classes.paper}>
        ...
        <form onSubmit={this.login.bind(this)} className={classes.form}>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="email" ref={(input) => this.email = input}>Email Address</InputLabel>
            <Input
              id="email"
              name="email"
              autoComplete="email"
          ...
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="password" ref={(input) => this.password = input}>Password</InputLabel>
            <Input
              name="password"
              type="password"
              id="password"
